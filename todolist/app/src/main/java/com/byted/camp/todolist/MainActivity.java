...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        try {
             cursor = db.query(
                    ...
                    projiection,selection,selectionargs,
                    null,null, TodoContract.TodoEntry.Priority+" desc"
            );
            while (cursor.moveToNext())
            {
                String content = cursor.getString(cursor.getColumnIndex(TodoContract.TodoEntry.CONTENT));
                long dateMs = cursor.getLong(cursor.getColumnIndex(TodoContract.TodoEntry.DATE));
                int intState = cursor.getInt(cursor.getColumnIndex(TodoContract.TodoEntry.STATE));
                long id = cursor.getLong(cursor.getColumnIndex(TodoContract.TodoEntry._ID));
                int intPriority = cursor.getInt(cursor.getColumnIndex(TodoContract.TodoEntry.Priority));
    ...
    private void updateNode(Note note) {
        ...
        values.put(TodoContract.TodoEntry.STATE,state);
